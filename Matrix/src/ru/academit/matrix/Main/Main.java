...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Матрица1 = " + matrix1.toString());

        double[][] array = {{1, 2, 3}, {3, 2, 1}, {1, 1, 1}};
        Matrix matrix2 = new Matrix(array);
        System.out.println("Матрица2 = " + matrix2.toString());
        ...
        System.out.println("Матрица3 = " + matrix3.toString());

        Matrix matrix4 = new Matrix(matrix3);
        System.out.println("Матрица4 = " + matrix4);
        System.out.println("Размерность матрицы4 = " + matrix4.getSize());

        matrix4.setVectorString(2, new Vector(new double[]{0, 1, 1, 2}));
        System.out.println("Вектор строка матрицы4 по индексу 2 = " + matrix4.getVectorString(2));

        System.out.println("Вектор строка матрицы4 по индексу 0 = " + matrix4.getVectorColumn(0));

        double[][] array1 = {{7, 3}, {0, 2}, {6, 1}};
